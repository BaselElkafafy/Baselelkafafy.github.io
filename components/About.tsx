    ...
    >
      <div className="flex flex-col  justify-around flex-wrap items-center   max-w-[900px]">
        ...
        <p className="text-gray-300 text-center ">
          As a dedicated E-commerce Web Designer, Basel Elkafafy, I'm fueled by the dynamic intersection of design
         innovation and user-centric functionality.
         Specializing in crafting visually captivating online shopping experiences,
          <br />
          <br />
